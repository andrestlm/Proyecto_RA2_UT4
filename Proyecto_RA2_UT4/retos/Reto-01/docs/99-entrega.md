...
- **[Fase 4: Repositorio](./04-repositorio.md)**
  - *Ficheros extra incluidos en el repositorio*
...
He elegido la versión Pro ya que es la Profesional y la ideal para oficina, permitiendo integraciones en dominios con Active Directory y más opciones que la versión Home no ofrece.
...
- **Evidencia fotográfica:** ![WebApp](../assets/02-software/gmail_app.png "Webs como aplicaciones, proceso de guardarlas")
[⬅️ Volver a portada e índice](00-portada.md)
...
---
# 04-Repositorio
# EJERCICIO 4: Repositorio en GitHub
...
A parte de los **README**, se han añadido un fichero de **portada** y otro para la **entrega** con todo los documentos y un índice dentro de la portada, en lugar de estar en un fichero a parte.

Las rutas de los enlaces de los README no funcionarán ya que esta en carpeta distintas y los enlaces no están adaptados.
...
---
# README del reto
# RETO 01: Configuración y Documentación PC de Oficina Completo
## Índice
- **[Portada](./docs/00-portada.md)**
  - *Portada e índice del proyecto*
* **[Fase 1: Entorno Virtual e Instalación de Windows](./docs/01-entorno.md)**
  * *Detalles sobre el uso de VMware, asignación de hardware (10GB RAM, 2 Cores) y creación de los usuarios locales (admin y trabajador).*
